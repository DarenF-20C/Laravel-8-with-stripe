...
Route::get('/addProduct',[App\Http\Controllers\ManageProductController::class,'index'])->
name('add.Product');

Route::post('/addCategory/store',[App\Http\Controllers\CategoryController::class,'add'])->
name('addCategory');

Route::post('/addproduct/store',[App\Http\Controllers\ManageProductController::class,'add'])->
name('addProduct');

Route::get('/showCategory',[App\Http\Controllers\CategoryController::class,'view'])->
name('showCategory');

Route::get('/showProduct',[App\Http\Controllers\ManageProductController::class,'view'])->
name('showProduct');

Route::get('/deleteProduct/{id}',[App\Http\Controllers\ManageProductController::class,'delete'])->
name('deleteProduct');
...
Route::post('/searchProducts',[App\Http\Controllers\ProductController::class,'searchProduct'])->
name('search.product');
